...
def get_db_connection():
    ...
    #the db connection will return rows we can access like python dictionairies
...
def create():
    if request.method == "POST":
        ...
        #display an error if title or content is null
        #otherwise make the database connection and insert the post
        if not title:
